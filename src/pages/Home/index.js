    ...
    <Box flex={1} backgroundColor="#f8f8f8" flexDirection="column">
      <HStack padding={4} w="100%" alignItems="center" justifyContent="space-between" safeArea>
        ...
        <Box rounded="md" flexDir="row" alignItems="center">
          ...
          <Pressable>
            <Avatar
              source={{ uri: "https://avatars.githubusercontent.com/u/83180302?v=4.png" }}
              height={12}
              width={12}
            />
          </Pressable>
      ...
      <Box paddingX={4}>
        <FlatList
          horizontal={true}
          data={data}  //pega a lista
          renderItem={({ item }) => <Storys data={item} />}  //renderiza a lista no components/Storys, data={item}=tem acesso a todas as propriedades da lista
      ...
      <Box paddingX={4}>
        <FlatList
          data={data}  //pega a lista
          renderItem={({ item }) => <Feed data={item} />}  //renderiza a lista no components/Feed, data={item}=tem acesso a todas as propriedades da lista
